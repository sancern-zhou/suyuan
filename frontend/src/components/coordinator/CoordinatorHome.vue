...
<style scoped>
.coordinator-home { --ink: #102a38; --muted: #607987; --line: #d9e8ea; --teal: #0d8994; position: relative; min-height: 100%; overflow: auto; background: linear-gradient(155deg, #eff8f7 0%, #f7faf8 43%, #edf4f5 100%); color: var(--ink); }
