...
<style scoped>
.resource-preview-host { height: 100%; min-height: 0; background: var(--bg-container); }.preview-layout { position: relative; display: flex; height: 100%; min-height: 0; flex-direction: column; }.preview-content { min-height: 0; flex: 1; }.state { display: grid; height: 100%; margin: 0; place-content: center; color: var(--text-2); text-align: center; }.error { color: var(--color-danger); }.state button { border: 0; background: transparent; color: var(--color-primary); cursor: pointer; }
.document-toolbar { position: relative; z-index: 10; display: flex; min-height: 52px; flex: 0 0 auto; align-items: center; gap: 10px; padding: 8px 12px; border-bottom: 1px solid #e5eaf0; box-sizing: border-box; background: var(--bg-container); }.document-picker { min-width: 0; flex: 1; }.document-picker select { width: 100%; min-height: 34px; padding: 5px 30px 5px 9px; overflow: hidden; border: 1px solid #d5dde8; border-radius: 6px; background: var(--bg-container); color: #17223b; font: inherit; text-overflow: ellipsis; }.document-meta { display: flex; align-items: center; gap: 5px; color: var(--text-2); font-size: 11px; white-space: nowrap; }.document-meta span { padding: 3px 6px; border-radius: 999px; background: #f1f5f9; }.document-meta .latest { background: #eaf7ee; color: #15803d; }.sr-only { position: absolute; width: 1px; height: 1px; padding: 0; overflow: hidden; clip: rect(0, 0, 0, 0); white-space: nowrap; border: 0; }
