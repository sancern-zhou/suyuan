...
<style scoped>.details { padding: 24px; }.details dl { display: grid; grid-template-columns: 90px 1fr; gap: 8px; }.details dt { color: var(--text-2); }.details dd { margin: 0; }.details button { border: 0; background: transparent; color: var(--color-primary); cursor: pointer; }.details .back { padding: 0 0 12px; }.image-preview { display: block; max-width: 100%; max-height: 55vh; object-fit: contain; }.notice { color: var(--text-2); }.error { color: var(--color-danger); }.content-ref { display: none; }</style>
