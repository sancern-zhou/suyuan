...
<style scoped>.slides { height: 100%; padding: 16px; overflow: auto; box-sizing: border-box; }.slides img { display: block; width: min(100%, 1100px); margin: 0 auto 16px; box-shadow: 0 2px 12px #0002; }</style>
