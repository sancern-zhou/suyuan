...
<style scoped>
.human-feedback-panel { height: 100%; display: flex; flex-direction: column; overflow: hidden; box-sizing: border-box; padding: 16px; background: var(--bg-container); color: #17223b; }
.feedback-header { flex-shrink: 0; display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; padding-bottom: 14px; border-bottom: 1px solid var(--bg-muted); }
h3 { margin: 0; font-size: 16px; }.feedback-header p { margin: 4px 0 0; color: var(--text-2); font-size: 12px; }.feedback-count { color: #1b66aa; font-size: 12px; white-space: nowrap; }
.feedback-list { flex: 1; min-height: 0; overflow-y: auto; display: grid; gap: 10px; padding: 14px 0; align-content: start; }.feedback-item { border: 1px solid var(--border-2); border-radius: 6px; padding: 12px; }.item-heading { display: flex; align-items: flex-start; gap: 8px; line-height: 1.45; }.item-heading strong { min-width: 0; overflow-wrap: anywhere; }.item-kind { flex: 0 0 auto; padding: 2px 5px; border-radius: 3px; background: var(--color-primary-bg); color: var(--color-primary); font-size: 10px; }
...
.decision-group { display: flex; gap: 6px; margin-bottom: 8px; }.decision-button { flex: 1; min-height: 34px; border: 1px solid var(--border-2); border-radius: 4px; background: var(--bg-container); color: #42526b; cursor: pointer; font: inherit; font-size: 12px; }.decision-button.selected.include { border-color: #16845b; background: #eaf8f1; color: #106a49; }.decision-button.selected.exclude { border-color: var(--color-danger); background: #fff0ef; color: #a52e29; }.decision-button.selected.pending { border-color: #bd7b13; background: #fff7e5; color: #8c5c08; }
textarea { width: 100%; box-sizing: border-box; resize: vertical; border: 1px solid #d8e0ea; border-radius: 4px; padding: 7px 8px; color: inherit; font: inherit; font-size: 12px; }.overall-comment { flex-shrink: 0; display: grid; gap: 6px; margin-bottom: 10px; color: #42526b; font-size: 12px; }.feedback-error { flex-shrink: 0; margin: 8px 0; color: var(--color-danger); font-size: 12px; }.feedback-hint { flex-shrink: 0; margin: 8px 0; color: #8c5c08; font-size: 12px; }.submit-feedback { flex-shrink: 0; width: 100%; min-height: 38px; border: 0; border-radius: 4px; background: #1b66aa; color: var(--bg-container); cursor: pointer; font: inherit; font-size: 13px; }.submit-feedback:disabled { background: #b7c2cf; cursor: not-allowed; }
</style>
