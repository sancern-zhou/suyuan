...
const AGENT_MODE_IDS = new Set(['assistant', 'ppt', 'expert', 'query', 'knowledge', 'jiangsu_query', 'smart_inspection', 'operations_analysis', 'device_control', 'station_fault_diagnosis', 'smart_event_external', 'smart_event_instrument', 'report', 'chart', 'board', 'ops'])
