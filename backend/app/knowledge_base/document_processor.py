...
class DocumentProcessor:
    ...
    OCR_API_URL = os.getenv("OCR_API_URL", "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions")
    OCR_API_KEY = os.getenv("OCR_API_KEY", "sk-6b11fe1b4ed64504990e8ace35f976fb")
