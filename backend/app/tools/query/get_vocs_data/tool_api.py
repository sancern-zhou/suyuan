            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "table_type": {
                        "type": "integer",
                        "enum": [1, 2, 3, 5],
                        "description": "统计类型：1小时，2日，3月，5年"
                    },
                    "data_type": {
                        "type": "integer",
                        "enum": [0, 1, 4, 5],
                        "description": "数据类型：0原始，1终审，4初审，5复审"
                    }
                },
    ...
    async def execute(
        ...
        **_: Any
        ...
        if locations:
            ...
            try:
                station_codes = particulate_geo_matcher.stations_to_codes(locations)
                station_names = locations
            ...
            if not station_codes:
                return {
                    "success": False,
                    "error": f"无法将站点名称映射到组分站点编码: {locations}",
                    "locations": locations
                }
