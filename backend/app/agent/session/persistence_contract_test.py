...
def test_versioned_drawio_persistence_keeps_only_lightweight_board_index():
    session = Session(
        session_id="board_session_versioned",
        query="画板",
        metadata={"mode": "board"},
        conversation_history=_messages(2),
    )
    ...
    ConversationPersistenceService().apply_complete(
        ...
        drawio_board={
            ...
            "revision": 3,
            "current_xml": "<mxfile>large xml</mxfile>",
