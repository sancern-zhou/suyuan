...
class PdfParserProvider:
    """PDF parser for cognitive map source documents."""
    ...
    def _extract_with_pdfplumber(self, source_file: SourceFile) -> str:
        try:
            import pdfplumber
        except ImportError:
            return ""
    ...
    def _extract_with_pypdf2(self, source_file: SourceFile) -> str:
        try:
            import PyPDF2
