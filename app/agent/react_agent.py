...
class ReActAgent:
    ...
    async def analyze(
        ...
        manual_mode: Optional[str] = None  # ✅ 双模式架构：assistant/expert
        ...
        logger.info(
            ...
            manual_mode=manual_mode or "expert"  # ✅ 记录双模式架构模式
        )
        ...
        try:
            ...
            async for event in react_loop.run(
                ...
                debug_mode=debug_mode,
                initial_messages=initial_messages,  # ✅ 传递历史消息
                manual_mode=manual_mode  # ✅ 传递双模式架构模式
            ):
                yield event
