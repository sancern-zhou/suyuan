...
class DataExtractor:
    ...
    @staticmethod
    async def extract_table(page: Page, selector: str = "table") -> Dict[str, Any]:
        """Extract table data
    ...
    @staticmethod
    async def extract_list(page: Page, selector: str = "ul, ol") -> Dict[str, Any]:
        """Extract list data
        ...
        """
        list_data = await page.eval_on_selector_all(
            selector,
            """(lists) => {
    ...
    @staticmethod
    async def extract_form(page: Page, selector: str = "form") -> Dict[str, Any]:
        """Extract form data
    ...
    @staticmethod
    async def extract_links(page: Page, selector: str = "a") -> Dict[str, Any]:
        """Extract all links
    ...
    @staticmethod
    async def extract_images(page: Page, selector: str = "img") -> Dict[str, Any]:
        """Extract all images
