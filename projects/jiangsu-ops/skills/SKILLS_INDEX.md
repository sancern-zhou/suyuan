...
- [江苏数据审核AI复核](data-audit-review/SKILL.md) - 复核江苏省审核平台已完成初审的站点-审核日数据准确性。从平台证据包读取初审结果、恒值、离群值三页签审核记录及其监测、仪器、设备、质控、工单、门禁、动环、气象证据链，判断平台初审操作是否有证据支撑，生成可人工确认的 AI 审核结论；平台人工审核日志回流后按人工口径增量修正。
